<head id="candidate-navbar shadow-sm" class="bg-white">
    <div class="max-width-container py-1">
        <div class="d-flex align-items-center my-2">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <button type="button" class="btn rounded-end color-black fontsize-14 font-500" id="user-name" data-bs-toggle="dropdown">Username <span data-feather="chevron-down" class="color-black"></span></button>
                    <ul class="dropdown-menu mt-1 p-2">
                        ...
                        <li><a href="#" class="dropdown-item rounded py-2 pe-5 color-light fontsize-14 font-400">Job Applications</a></li>
