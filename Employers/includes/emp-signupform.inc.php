  ...
  <form action="#" id="employer_registration_form">
    ...
    <div class="row">
      ...
      <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
        ...
        <label for="hidden_company_logo" class="btn bg-cp2 fontsize-13 font-500 px-3">Upload Logo</label>
    ...
    <div class="text-end">
      <a href="#" class="btn bg-cp2 fontsize-14 font-500 px-5 py-2" onclick="validate_employer_form()">Register</a>
    </div>
  </form>
</div>