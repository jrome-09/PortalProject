                ...
                <div id="thread01" class="border-bottom px-4 py-2 color-black">
                    <div class="row">
                        <div class="col-sm-9 text-start d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <a href="thread-index.php" id="thread-btn-01" class="fontsize-14 hover-text-underline font-500 text-decoration-none color-black mb-0 hover-text-primary">Thread Name or Title</a>
                                <p class="color-light font-super--small mb-0">Monday at 6:00 PM</p>
                            </div>
                        </div>
                        <div class="col-sm-3 text-end" id="forum-by-textend">
