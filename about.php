...
<body>
    ...
    <main>
        <div class="bg-white">
            <div class="max-width-container">
                <h1 class="color-black mb-4">About Us</h1>
                <h4 class="font-500 color-black">University History</h4>
                <div class="row">
                    <div class="col-lg-6">
                        <p class="fontsize-13 mb-4 color-black text-justify">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container mb-4 bg-white" style="height: 300px; width: 100%;">
                            <img src="Images/unp-vintage.png" alt="unp_image">
                        </div>
                    </div>
                </div>
                <p class="fontsize-13 mb-4 color-black text-justify">
        ...
        <div class="bg-light">
            <div class="max-width-container">
                <div class="text-center">
                    ...
                    <p class="fontsize-14 text-secondary">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Laudantium itaque neque, assumenda
                    </p>
                </div>
                <div class="carousel-container mt-5 shadow-sm border rounded bg-white">
                    <div id="groupCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner" style="padding: 50px;">
                            <div class="carousel-item active text-center bg-white rounded" data-bs-interval="10000">
                                <div class="image-container border rounded-circle m-auto mb-3" style="height: 100px; width: 100px;">
                                    <img src="images/default_profile.png" alt="">
                                </div>
                                <h5 class="color-black font-500">Jerome Cabrera</h5>
                                <p class="fontsize-13 text-secondary">BS INFOTECH 3C</p>
                                <p class="fontsize-13 text-secondary mb-5">
                                    Group Leader, Incharge of Developing <br> and Designing the System
                                </p>
                            ...
                            <div class="carousel-item text-center bg-white rounded" data-bs-interval="10000">
                                ...
                                <p class="fontsize-13 text-secondary">BS INFOTECH 3C</p>
                                <p class="fontsize-13 text-secondary mb-5">
                                    Analyst, Tester, Incharge of the<br> Project Documentation
                                </p>
    ...
    <script>
        ...
        var parent = document.getElementById('about-link').classList.add('active');
    </script>
