    ...
    <main>
        ...
        <div class="bg-white">
            <div class="max-width-container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <p class="fontsize-13 mb-4 color-light text-justify">
        ...
        <div class="bg-light">
            <div class="max-width-container">
                ...
                <div class="carousel-container mt-5 shadow-sm border rounded">
                    <div id="groupCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active text-center bg-white rounded" data-bs-interval="10000">
                                ...
                                <p class="fontsize-13 color-light">BS INFOTECH 3C</p>
